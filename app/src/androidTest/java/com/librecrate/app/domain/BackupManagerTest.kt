...
class BackupManagerTest {
    ...
    private lateinit var dao: com.librecrate.app.data.db.DocumentDao
    ...
    fun setUp() {
        ...
        db = LibreCrateDatabase.create(context, masterKey)
        dao = db.documentDao()
    ...
    fun backupAndRestoreCrossDevice() = runTest {
        ...
        val restoredDb = LibreCrateDatabase.create(context, restoredMasterKey!!)
    ...
    fun backupAfterUninstallReinstall() = runTest {
        ...
        // Data intact
        val restoredDb = LibreCrateDatabase.create(context, restoredKey!!)
        val restoredDao = restoredDb.documentDao()
        val docs = restoredDao.getAllDocuments().first()
        assertEquals(1, docs.size)
    ...
    fun importBackupWithDifferentMasterKeyAndPasswordIntoExistingContent() = runTest {
        ...
        // B's DB uses the same file path ("librecrate.db") since exportBackup() hardcodes it.
        ...
        val dbB = LibreCrateDatabase.create(context, masterKeyB!!)
        ...
        val dbA2 = LibreCrateDatabase.create(context, restoredMasterKeyA!!)
        ...
        dbA2.close()
        val reopenedDb = LibreCrateDatabase.create(context, masterKey)
