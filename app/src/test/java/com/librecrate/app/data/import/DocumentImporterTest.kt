...
import com.librecrate.app.data.encryption.TestKeyStoreCryptographer
...
class DocumentImporterTest {
    ...
    fun setUp() {
        ...
        val mockProcessor = mockk<com.librecrate.app.vault.reader.DocumentProcessor>()
        coEvery { mockProcessor.process(any(), any()) } returns com.librecrate.app.vault.reader.ProcessorResult(
    ...
    private fun createPkPass(organizationName: String, description: String): File {
        ...
        val passJson = JSONObject().apply {
            put("formatVersion", 1)
            put("passTypeIdentifier", "pass.com.librecrate.app.test")
