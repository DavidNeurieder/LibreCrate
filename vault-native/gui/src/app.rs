...
mod tests {
    ...
    #[test]
    fn navigate_to_first_run_switches_to_first_run_screen() {
        ...
        let task = update(&mut app, Message::Navigate(Navigation::FirstRun));
        assert!(matches!(&app.screen, Screen::FirstRun(_)));
